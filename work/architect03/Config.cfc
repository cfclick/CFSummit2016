component  output="false"
{
	...
	public Config function init(){
		...
		var dependency = {};
		dependency.id = "DAL";
		dependency.map = "CFSummit2016.work.architect03.Repository.DAL";				
		this.injection.locations.append(dependency);
		
		dependency = {};
		dependency.id = "TRNS";
		dependency.map = "CFSummit2016.work.architect03.Translators";
		this.injection.locations.append(dependency);
		
		dependency = {};
		dependency.id = "REP";
		dependency.map = "CFSummit2016.work.architect03.Repository.AutoGenerated";
		this.injection.locations.append(dependency);
