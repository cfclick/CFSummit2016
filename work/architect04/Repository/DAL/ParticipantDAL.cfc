...
{	
	...
	property name="personDAO" inject="REP:PersonDAO";
	...
	public Participant function getParticipantById(required numeric personID ){
		var participant = new Participant();
		var person = new Person();
		var lectures = [];
		person = this.personDAO.read( arguments.personID );
		//Person
		participant.person = person;
		//End
		//Conference
