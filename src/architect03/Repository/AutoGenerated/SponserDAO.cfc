component output="false"
{
	...
	/* create */
	public any function create( numeric SponserTypeID, numeric ConferenceID= 0, string Name, numeric IsActive= 0, string CreatedBy= '', date CreatedDateTime= '01/01/1900', string UpdatedBy= '', date UpdatedDateTime= '01/01/1900' )
	{
		...
		q.setsql('INSERT INTO Conf.Sponser
			(
				sponsertypeid,conferenceid,name,isactive,
				createdby,createddatetime,updatedby,updateddatetime
			)
			VALUES
			(
				#ARGUMENTS.SponserTypeID#,
		...
		if(arguments.SponserID NEQ '')
			IdentityCol=arguments.SponserID;
	...
	/* read */
	public Sponser function read(id)
	    {
		
		/* Auto-generated method
		         Add authroization or any logical checks for secure access to your data */
		var obj = createObject('component', 'Sponser').init();
		var i = 1;
		var qry="";
		
		var q= new query();
		q.setdatasource("dsnConference");
		q.setsql('SELECT sponserid,sponsertypeid,conferenceid,name,isactive,
					createdby,createddatetime,updatedby,updateddatetime
			FROM Conf.Sponser
			where sponserid = "#ARGUMENTS.id#"');
		qry=q.execute().getresult();	
		/* load value object */
		obj.setSponserID(qry.SponserID[i]);
	...
	/* update */
	public void function update(numeric SponserID,	numeric SponserTypeID,	numeric ConferenceID,	string Name,	numeric IsActive,	string CreatedBy,	date CreatedDateTime,	string UpdatedBy,	date UpdatedDateTime)
		{
		/* Auto-generated method
		         Add authroization or any logical checks for secure access to your data */
		...
		var q =new query();
		q.setdatasource("dsnConference");
		q.setsql('UPDATE Conf.Sponser
			SET sponsertypeid = "#ARGUMENTS.SponserTypeID#" ,
			...
			WHERE sponserid = "#ARGUMENTS.SponserID#" ');
	    qry=q.execute().getresult();		
	...
	/* delete */
	public void function delete(numeric SponserID)
		{
		/* Auto-generated method
		         Add authroization or any logical checks for secure access to your data */
		var qry="";
		...
		var q =new query();
		q.setdatasource("dsnConference");
		q.setsql('DELETE FROM Conf.Sponser
			WHERE sponserid = "#ARGUMENTS.SponserID#"' );
		qry=q.execute().getresult();
